var Guest_List = ["Fawwad Ahmed", "Dawood", "Daniyal", "Zeeshan"];
...
while (Guest_List.length > 2) {
    var remove_g = Guest_List.pop();
    console.log("Sorry ".concat(remove_g, " ! that I would not able to invite you to Dinner"));
}
for (var i = 0; i < Guest_List.length; i++) {
